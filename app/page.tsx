    ...
    <div className="min-h-screen bg-stone-50 text-stone-800 relative">
      ...
      <section id="apartments" className="max-w-6xl mx-auto px-6 py-24 scroll-mt-6">
        <div className="text-center mb-16">
          ...
          <p className="text-stone-600 max-w-xl mx-auto">3 rodzaje przestronnych i doskonale wyposażonych wnętrz stworzonych dla par oraz rodzin.</p>
        </div>
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="w-full p-6 text-left flex justify-between items-center font-bold text-stone-900 focus:outline-none"
                  >
              ...
              <div className="w-full flex flex-col items-center">
                <div className="h-12 relative w-36 mb-4">
                  <Image 
                    ...
                    alt="https://www.booking.com/hotel/pl/puerto-wladyslawowo.pl.html#tab-reviews" 
                    fill 
        ...
        >
          ...
          >
            ...
            <div className="relative h-60 md:h-72 w-full rounded-2xl overflow-hidden bg-stone-100 mb-4 shadow-inner">
              ...
              <button 
                onClick={() => setActiveImageIndex((prev) => (prev === apartmentImages.length - 1 ? 0 : prev + 1))}
                className="absolute right-3 top-1/2 -translate-y-1/2 bg-white/90 hover:bg-white text-stone-900 w-9 h-9 rounded-full flex items-center justify-center shadow-md font-bold transition cursor-pointer"
              >
                &rarr;
              </button>
            </div>
